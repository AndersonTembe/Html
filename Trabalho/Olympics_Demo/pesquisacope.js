...
var vm = function () {
    ...
    self.displayName = 'Pesquisa por copeticoes';
...
function test(){
    ...
    location.href="./pesquisacope.html?query="+obj // go to the another page to avoid ko multiple element bidding error
}
...
function myfunc(id){
    ...
    if(location.href.includes("competitions") || location.href.includes("query")){
