// ViewModel KnockOut
var vm = function (queryTo,isSearch) {
...
function myfunc(id){
    ...
    if(location.href.includes("athletes") || localStorage.href.includes("query")){
...
function goTO(id){
    ...
    location.href="./athletesDetalhes.html?id="+id
}
...
function test(){
    ...
    location.href="./pesquisa.html?query="+obj
}
